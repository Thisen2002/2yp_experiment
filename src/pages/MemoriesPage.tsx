    ...
    <div className="p-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {memories.map((m) => (
            <div key={m.id} className="bg-white rounded shadow-sm p-2 text-sm overflow-hidden">
              ...
              <div className="text-xxs text-gray-400 mt-1">{m.created_at ? new Date(m.created_at).toLocaleDateString() : '—'}</div>
            </div>
          ))}
        </div>
      </div>
