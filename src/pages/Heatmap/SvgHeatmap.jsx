...
const API_URL = import.meta.env.VITE_HEATMAP_API_URL ? `${import.meta.env.VITE_HEATMAP_API_URL}/heatmap/map-data` : "http://localhost:3036/heatmap/map-data";
...
/* === Label tuning === */
const LABEL_MIN = 6;          // px
const LABEL_MAX = 12;         // px
